...
elect <- electricity output (54000 ~ 60000)

```{r valuep, echo=TRUE}
source(here("week3/R/compute_NPV.R"))
source(here("week3/R/compute_profit_frompower.R"))
source(here("week3/R/solarpv.R"))
...
load(here("week3/data/annual_elect_solar.rda"))
head(sierraczosolar)

profit_solar <- compute_profit_frompower(
  energy = sierraczosolar$elect,
  year = sierraczosolar$year,
